...
// from this sample.
// BoundaryCallback里面的三个回调可能会触发多次，为了避免重复调用Api，google设计了该类
public class PagingRequestHelper {
     ...
     * <p>
     * When a request is invoked, it must call one of {@link Callback#}
    ...
    public static final class StatusReport {
        ...
        /**
         * Convenience method to checkMulti if there are any running requests.
         *
        ...
        /**
         * Convenience method to checkMulti if there are any requests that resulted in an error.
         *
         ...
         * @return The {@link } returned by the failing request with the given type or
